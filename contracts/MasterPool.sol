...
contract MasterPool is Ownable, ReentrancyGuard {
    ...
    struct UserInfo { 
        ...
        uint256 latestTimestamp; //latest timestamp that user deposits.
    ...
    // Info of each pool.
    struct PoolInfo {
        IERC20 lpToken;           // Address of LP token contract. in this case Lucky -busd.
        uint8 category; //what date is this pool collect the information.
    ...
    // mapping(address => bool) public isAddedPool; //might be useful later but not now.
    ...
    constructor(
        ...
        poolInfo.push(PoolInfo({
            lpToken : _luckyBusd,        // Address of LP token contract. in this case Lucky -busd.
            category:  1,         //what date is this pool collect the information.
            allocPoint: 0,   // How many allocation points assigned to this pool. luckys to distribute per block.
            lastRewardBlock:0 , // Last block number that luckys distribution occurs.
            accLuckyPerShare:0 , // Accumulated luckys per share, times 1e12. See below.
            harvestTimestamp:0 ,// Harvest interval in unixtimestamp
            farmStartDate:0
        }));
        poolInfo.push(PoolInfo({
            lpToken : _luckyBusd,        // Address of LP token contract. in this case Lucky -busd.
            category:  2,         //what date is this pool collect the information.
            allocPoint: 0,   // How many allocation points assigned to this pool. luckys to distribute per block.
            lastRewardBlock:0 , // Last block number that luckys distribution occurs.
            accLuckyPerShare:0 , // Accumulated luckys per share, times 1e12. See below.
            harvestTimestamp:0 ,// Harvest interval in unixtimestamp
        ...
        poolInfo.push(PoolInfo({
            lpToken : _luckyBusd,        // Address of LP token contract. in this case Lucky -busd.
            category:  3,         //what date is this pool collect the information.
            allocPoint: 0,   // How many allocation points assigned to this pool. luckys to distribute per block.
            lastRewardBlock:0 , // Last block number that luckys distribution occurs.
            accLuckyPerShare:0 , // Accumulated luckys per share, times 1e12. See below.
            harvestTimestamp:0 ,// Harvest interval in unixtimestamp
        ...
        poolInfo.push(PoolInfo({
            lpToken : _luckyBusd,        // Address of LP token contract. in this case Lucky -busd.
            category:  4,         //what date is this pool collect the information.
            allocPoint: 0,   // How many allocation points assigned to this pool. luckys to distribute per block.
            lastRewardBlock:0 , // Last block number that luckys distribution occurs.
            accLuckyPerShare:0 , // Accumulated luckys per share, times 1e12. See below.
            harvestTimestamp:0 ,// Harvest interval in unixtimestamp
        ...
        poolInfo.push(PoolInfo({
            lpToken : _luckyBusd,        // Address of LP token contract. in this case Lucky -busd.
            category:  5,         //what date is this pool collect the information.
            allocPoint: 0,   // How many allocation points assigned to this pool. luckys to distribute per block.
            lastRewardBlock:0 , // Last block number that luckys distribution occurs.
            accLuckyPerShare:0 , // Accumulated luckys per share, times 1e12. See below.
            harvestTimestamp:0 ,// Harvest interval in unixtimestamp
        ...
        poolInfo.push(PoolInfo({
            lpToken : _luckyBusd,        // Address of LP token contract. in this case Lucky -busd.
            category:  6,         //what date is this pool collect the information.
            allocPoint: 0,   // How many allocation points assigned to this pool. luckys to distribute per block.
            lastRewardBlock:0 , // Last block number that luckys distribution occurs.
            accLuckyPerShare:0 , // Accumulated luckys per share, times 1e12. See below.
            harvestTimestamp:0 ,// Harvest interval in unixtimestamp
        ...
        poolInfo.push(PoolInfo({
            lpToken : _luckyBusd,        // Address of LP token contract. in this case Lucky -busd.
            category:  7,         //what date is this pool collect the information.
            allocPoint: 0,   // How many allocation points assigned to this pool. luckys to distribute per block.
            lastRewardBlock:0 , // Last block number that luckys distribution occurs.
            accLuckyPerShare:0 , // Accumulated luckys per share, times 1e12. See below.
            harvestTimestamp:0 ,// Harvest interval in unixtimestamp
    ...
    //     }
    // }
    // Set the migrator contract. Can only be called by the owner. might change to setRevPool instead.
    ...
    function withdraw(uint256 _pid, uint256 _amount) external nonReentrant {
        PoolInfo storage pool = poolInfo[_pid];
        UserInfo storage user = userInfo[_pid][msg.sender];
        require(user.amount >= _amount, "MasterPool.sol :withdraw : withdraw exceeds the user.amount");
        //updatePool(_pid);
        //payOrLockupPendingLucky(_pid);
        if (_amount > 0) {
    ...
    function safeRewardTransfer(address _to, uint256 _amount) internal nonReentrant{
        revPool.safeRewardTransfer(_to, _amount);
    }
